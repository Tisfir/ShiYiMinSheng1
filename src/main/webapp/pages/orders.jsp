...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="${APP_PATH}/index.jsp"><i class="fa fa-home"></i> 首页</a></li>
                <li><a href="/orders/findall">订单管理</a></li>
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <td>${orders.u_name}</td>
                                <td>${orders.u_addr}</td>
                                <td>${orders.creat_timestr}</td>
                                <td>${orders.u_phone}</td>
                                ...
                                <td class="text-center">
                                    ...
                                    <button type="button" class="btn bg-olive btn-xs" onclick="location.href='/orders/findallById/${orders.id}'">详情</button>
